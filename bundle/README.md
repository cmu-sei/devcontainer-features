...
```bash
# POSIX
curl -fsSL https://github.com/cmu-sei/devcontainer-features/releases/latest/download/spawn.sh | bash -s -- <target-directory> --chat
```

```powershell
# Windows
& ([scriptblock]::Create((irm https://github.com/cmu-sei/devcontainer-features/releases/latest/download/spawn.ps1))) <target-directory> -Chat
```
